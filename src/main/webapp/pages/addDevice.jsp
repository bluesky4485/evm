...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/addDevice.js"></script>
...
<body id="addDeviceBody" class="easyui-layout"  > 
			...
			<tr style="padding-top: 5px">
			 ...
			 <div id="toolbar" class="toolbar">
			   ...
			   <div  id="addDeviceBtn">
				...
				<div  id="desc" style="float:left;;background-color:#060192;color:white;font-size:18px;width:180px;height:20px;padding-left:30px;padding-top:10px">添加设备</div>
			 </div>
		<div style="padding-left:20px">
			<table>
				<tr>
					<td style="width: 300px">设备类型名称<input style="width: 200px; height: 35px"
		...
		<div style="height:100%">
			...
			<thead>
				<tr>
					...
					<!-- <th data-options="field:'propertyNameDesc',width:280,align:'center'">属性名称描述</th> -->
				</tr>
			</thead>
		   </table>
	   </div>
	</div>
		<div id="property_window" title="增加属性" class="easyui-window"
		data-options="		
			modal : true,
			draggable : true,
			resizable : false,
