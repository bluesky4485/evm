...
<body id="updOrderBody" class="easyui-layout">
	<div data-options="region:'north', border:true" style="height: 217px;">
	   ...
	   <table style="width:100%">
		...
		<!-- 返回 -->
			...
			<div  id="desc" style="float:left;;background-color:#060192;color:white;font-size:18px;width:180px;height:20px;padding-left:30px;padding-top:10px">修改订单</div>
		</div>
		<div id="hidden_div">
		             <input type="hidden" id="orderId" name="orderid"  value="<c:out value='${updObj.orderId}'/>"  /><!--  订单ID-->
		  ...
		  <div class="easyui-tabs" style="width:100%;height:100%">
		      <div title="客户信息" style="padding:10px">
		          <table class="input_table">
		           <tr>
                           <td>订单编号</td>
                           <td colspan="3"><input id="orderNo" disabled="disabled" class="easyui-textbox"  style=" width:100%;background-color: #BABABA"/></td>
                           <td>项目经理</td>
                           <td><input id="pmName"  type="text" disabled="disabled"  class="easyui-textbox"   /></td>
                         </tr>
                         <tr>
                           <td rowspan="3">订单建码</td>
                           <td rowspan="3"><div id="qrcode"></div> </td>
                            <td>客户编号</td>
                         ...
                         <tr>
                           <td>服务截止日期</td>
                           <td><input  id="serviceEndDate"  disabled="disabled"  type="text" class="easyui-datebox" /></td>
                           <td>入网日期</td>
                           <td><input  id="joinDate"  disabled="disabled"  type="text" class="easyui-datebox" /></td>
                         </tr>
                         <tr>
                           <td>停机日期</td>
                           <td><input  id="stopDate"  disabled="disabled"  type="text" class="easyui-datebox" /></td>
                           <td>项目分类</td>
              ...
              <div title="施工信息" style="padding:10px">
                 ...
                 <% UserVO currenUser=(UserVO)session.getAttribute("LOGIN_INFO");%>
                         ...
                         <tr>
                           <td>经度</td>
                           <td><input id="lng"    type="text" class="easyui-textbox" /></td>
                           <td>纬度</td>
                           <td><input id="lat"    type="text" class="easyui-textbox" /></td>
                         </tr>
                         <tr>
                           <td>施工单位</td>
                         ...
                         <tr>
                           <td>出库联系人</td>
                           <td><input id="outStoreContacter" style="width:100%"   type="text"  class="easyui-searchbox"  data-options="prompt:'搜索出库联系人',editable:false" /> </td>
                           <td>计划出库时间</td>
                         ...
                         <tr>
                           <td>内检人员</td>
                            <td><input id="checkPerson" style="width:100%"   type="text"  class="easyui-searchbox"  data-options="prompt:'搜索内检人员',editable:false" /></td>
                            <td>施工内检结果</td>
