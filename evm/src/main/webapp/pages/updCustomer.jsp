...
<!--自定义文件-->
<script
	src="http://webapi.amap.com/maps?v=1.3&key=e4a4a2fd139f9535810830feefddf38f&&plugin=AMap.OverView,AMap.ToolBar"></script>
...
<script type="text/javascript"	src="<%=request.getContextPath()%>/js/updCustomer.js"></script>
...
<body id="updCustomBody" class="easyui-layout">
	<div data-options="region:'north', border:true" style="height: 172px;">
		...
		<!-- 返回 -->
			...
			<div id="desc"
				style="float: left; background-color: #060192; color: white; font-size: 18px; width: 180px; height: 20px; padding-left: 30px; padding-top: 10px">更新客户信息</div>

		</div>
		<div id="hiden_div">
			<input id="hidden_updDate" name="updDate" type="hidden" value="<c:out value='${updObj.updDate}'/>" />
	...
	<div data-options="region:'center', border: true">
		...
		<table class="input_table">
			<tr>
				...
				<td>客户编号<span class="redStar">*</span></td>
				<td><input id="cno" name="cno" disabled="disabled" type="text"
					class="easyui-textbox" value="<c:out value='${updObj.cno}'/>"
					data-options="readonly:true" /></td>
				<td>客户电话1<span class="redStar">*</span></td>
				<td><input type="text" id="ctel1" name="ctel1"
					class="easyui-textbox" /></td>
			</tr>
			<tr>
				<td>客户电话2<span class="redStar">*</span></td>
				<td><input type="text" id="ctel2" name="ctel2"
					class="easyui-textbox" /></td>
				<td>客户性别</td>
				<td><input id="csex" name="csex" type="text"
					class="easyui-combobox"
					data-options=" panelHeight:'auto',valueField:'id',textField:'text',editable:false" /></td>
				<td>客户身份证号</td>
				<td><input id="cidCard" name="cidCard" type="text"
					class="easyui-textbox" /></td>
			</tr>

			<tr>
				<td>客户地址</td>
				<td colspan="5"><input id="caddress" name="caddress" style="width:400px" type="text" class="easyui-textbox" /> 
				<a id="updCusMap" href="#"	class="easyui-linkbutton">地图</a></td>
			</tr>
			<tr>
				<td>所属分局</td>
				<td><input id="substation" name="substation" type="text"
					class="easyui-textbox" /></td>
				<td>所属派出所</td>
				<td><input id="policestation" name="policestation" type="text"
					class="easyui-textbox" /></td>

				<td>用户类别</td>
				<td><input id="ctype" name="ctype" type="text"
					class="easyui-combobox"
					data-options=" panelHeight:'auto',valueField:'tvalue',textField:'tname',editable:false" /></td>
			<tr>
				<td>包含项目</td>
				<td colspan="5"><input id="projects" name="projects"
					disabled="disabled" type="text" multiline="true"
	...
	<form
		action="<%=request.getContextPath()%>/customController.do?method=returnManagePage"
		id="returnManagePage" method="post"></form>
</body>
</html>
