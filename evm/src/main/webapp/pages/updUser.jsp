...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/updUser.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/common/logout.js"></script>
</head>
<body id="updUserBody" class="easyui-layout">
	<div data-options="region:'north', border:true" style="height:102px;">
		...
		<!-- 返回 -->
			...
			<div id="saveUser">
             ...
             <div  id="desc" style="float:left;;background-color:#060192;color:white;font-size:18px;width:180px;height:20px;padding-left:30px;padding-top:10px">修改用户</div>
		</div>
		<div id="hidden_div">
		     <input id="uid" type="hidden"  value="<c:out value='${updObj.uid}'/>"  />
		     <input id="updDate" type="hidden"    />
	  ...
	  <div style="padding:10px">
		<table class="input_table">
			<tr>
				...
				<td><input  id="uname"  name="uname"  disabled="disabled"  type="text" class="easyui-textbox" data-options="readonly:true"  /></td>
				<td>用户性别</td>
