...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/updProject.js"></script>
...
<body id="updProjectBody"class="easyui-layout" >
	<div data-options="region:'north', border:true" style="height: 218px;">
		...
		<!-- 返回 -->
			...
			<div  id="desc" style="float:left;;background-color:#060192;color:white;font-size:18px;width:180px;height:20px;padding-left:30px;padding-top:10px">修改项目信息</div>
		</div>
		<div id="hidden_div">
			       <input type="hidden"  id="projectId" name="projectId"     value="<c:out value='${updObj.projectId}'/>"/>
		  ...
		  <div class="easyui-tabs" style="width:100%;height:100%">
		      <div title="客户信息" style="padding:10px">
		          <table class="input_table">
		           <tr>
                         ...
                         <tr>
                           <td>客户经理</td>
                           <td><input id="cmName"     type="text" class="easyui-searchbox" data-options="prompt:'搜索客户经理',editable:false"/></td>
                           <td>客户经理电话</td>
                           <td><input id="cmTel"       type="text" class="easyui-textbox"  disabled="disabled"   /></td>
                           <td>客户经理性别</td>
                           <td><input id="cmSex"   type="text" class="easyui-combobox" disabled="disabled"    data-options=" panelHeight:'auto',valueField:'id',textField:'text'"/></td>
                         </tr>
                         
                         <tr>
                           <td>项目经理</td>
                           <td><input id="pmName"  type="text" class="easyui-searchbox" data-options="prompt:'搜索项目经理',editable:false"/></td>
                            <td>项目经理电话</td>
                           <td><input id="pmTel"    type="text" class="easyui-textbox"   disabled="disabled"   /></td>
                           <td>项目经理性别</td>
                           <td><input id="pmSex"   type="text" class="easyui-combobox"  disabled="disabled"  data-options=" panelHeight:'auto',valueField:'id',textField:'text'"/></td>
                          </tr>
                         <tr>
                           <td>项目分类</td>
              ...
              <div title="合同信息" style="padding:10px">
                 <table class="input_table">
                         <tr>
                           <td>合同编号</td>
                           <td><input id="contractId"    disabled="disabled" type="text" class="easyui-textbox" /></td>
                           <td>签订日期</td>
                           <td><input id="signDate"    type="text" class="easyui-datebox" data-options="editable:false" /></td>
                           <td>合同金额</td>
                           <td><input id="contractSum"  type="text" class="easyui-numberbox"  precision="2"/></td>
                         </tr>
                         ...
                         <tr>
                           <td>年服务费</td>
                           <td><input id="pYearSum"type="text" class="easyui-numberbox"  precision="2"/></td>
                           <td>服务截止日期</td>
	...
	<div id="customer_window" title="客户信息" class="easyui-window"
		...
		style="width: 850px; height: 500px;">
		    <div class="easyui-layout" style="width:830px;height:460px;">
		       <div data-options="region:'north',split:false,border:true,collapsible:false" style="height:32px">
				    <input id="customSearch"   class="easyui-searchbox" data-options="prompt:'搜索设备项'" style="height:30px;width:100%;background-color: #BABABA"/>
		       </div>
		        <div data-options="region:'center',split:false,border:true,collapsible:false">
			        <table id="customerDg"class="easyui-datagrid" style="width:auto;height:auto"   
						...
						<thead>
							<tr>
							    <th data-options="field:'ck',checkbox:true,width:50"></th>
							    <th data-options="field:'cno',width:80,align:'center',hidden:true">客户编号</th>
								...
								<th data-options="field:'utype',width:80,formatter:function(value,row,index){return BasePage.UserTypeformater(value,row,index);}">用户类型</th>
		       ...
		       <div data-options="region:'north',split:false,border:true,collapsible:false" style="height:32px">
		        ...
		        <div data-options="region:'center',split:false,border:true,collapsible:false">
			        <table id="userDg"class="easyui-datagrid" style="width:auto;height:auto"   
						data-options="singleSelect:true,collapsible:false,fit:true,pagination:true,rownumbers:true,pageSize:10,pageList:[10,20,50],checkbox:true">
						<thead>
							<tr>
							    <th data-options="field:'ck',checkbox:true,width:50"></th>
