...
<script type="text/javascript" src="<%=request.getContextPath()%>/jscript/uploadify/upload_morder_file.js"></script> 
<script type="text/javascript" src="<%=request.getContextPath()%>/js/updMaintainOrder.js"></script>
...
<body id="updMorerBody"class="easyui-layout">
	<div data-options="region:'north', border:true" style="height: 218px;">
	    <table id="top" style="width: 100%; height: 50px; border: #F3F3F3; background-color: #FCFCFC">
				<tr style="padding-top: 5px">
					<td align="center"
						style="widht: 100px; border-right: #EEEEEE 1px solid;">您有 
						<span class="span-red" id="newMorder" style="color:red">0 </span> 新报修未处理
					</td>
					<td><input class="easyui-searchbox"    disabled="disabled"  style="background-color: #BABABA; width: 500px; height: 35px; padding-left: 20px" />
					</td>
	  ...
	  <table style="width:100%">
				<tr>
				  <td class="redTd_class">
					 ...
					 <div> 
						  <div class="td_digit_div_class">
							  <span style="font-size:30px;" id="uallNoDoMorderCnt">0</span>
						 </div>
				  ...
				  <td  class="yellowTd_class"> 
					 ...
					 <div> 
						  <div class="td_digit_div_class">
							  <span style="font-size:30px;" id="unoCallBackMorderCnt">0</span>
						 </div>
						  <div class="td_char_div_class">
				  ...
				  <td  class="blueTd_class">
					 ...
					 <div> 
						  <div class="td_digit_div_class">
							  <span style="font-size:30px;" id="udoingMorderCnt">0</span>
						 </div>
						  <div class="td_char_div_class">
				  ...
				  <td  class="purpleTd_class">
					 ...
					 <div> 
						  <div class="td_digit_div_class">
							  <span style="font-size:30px;" id="uproblemMorderCnt">0</span>
						 </div>
						  <div class="td_char_div_class">
		...
		<div id="toolbar" class="toolbar">
			...
			<div  id="desc" style="float:left;;background-color:#060192;color:white;font-size:18px;width:180px;height:20px;padding-left:30px;padding-top:10px">修改运维定单</div>
		</div>
		<div id="hidden_div">
		             <input type="hidden" id="morderId"  name="morderId" value="<c:out value='${updObj.morderId}'/>"/>
			         <input type="hidden"  id="hidden_updDate" name="updDate"   type="hidden"  />
			         <input type="hidden" id="morderPmId" name="morderPmId" /><!--  运维经理-->
			         <input type="hidden" id="maintainPmId" name="maintainPmId" /><!-- //维修负责人 -->
			         <!-- 客户地址-->
		...
		<div id="orderEdit" style="background-color: #f3f3f3">
			<table >
			  <tr>
			     ...
			     <td><input id="orderId"   disabled="disabled"  class="easyui-textbox"    style="width:200px;height:42px"></td>
			     <td>运维编号<span class="redStar">*</span></td>
			     <td><input id="maintainNo"   disabled="disabled"  class="easyui-textbox"  style="width:200px;height:42px"></td>
			     <td><div style="float:left;padding-left:30px">运维订单录入员：<%=session.getAttribute("LOGIN_NAME") %> </div>
			         <div style="float:left;padding-left:30px">当前日期：<span id="currentDate"></span></div></td>
			  </tr>
			</table>
		</div>
	</div>
		...
		<table class="input_table">
			<tr>
			    ...
			    <td rowspan="4" style="width:50px">
			        <div>维修图片</div>
                    <div>
                       <input type="button" id="morderFileList" name="morderFileList" class="button-z" value="上传" />
                    </div>
			    </td>
			...
			<tr>
				...
				<td><input id="lastUpdDate" type="text"  disabled="disabled"  class="easyui-datetimebox" style="width:100%;"/></td>
			...
			<tr>
				...
				<td>维修人数</td>
				<td><input id="maintainWorkerCnt"  type="text" class="easyui-numberbox" data-options="min:0,max:10000"></td>
			...
			<tr>
			 ...
			 <tr>
				...
				<td>维修进度</td>
				<td><input id="maintainSpeed" type="text" class="easyui-numberbox" data-options="min:0,max:100"/></td>
			</tr>
			<tr>
				<td>运维经理电话2</td>
			...
			<tr>
				...
				<td>用户评分</td>
				<td><input id="userScore"  type="text" class="easyui-numberbox" style="width:100%;" data-options="min:0,max:100"/></td>
			</tr>
			<tr>
				<td>验收回访人</td>
